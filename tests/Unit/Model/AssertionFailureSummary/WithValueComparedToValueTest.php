...
use webignition\BasilPhpUnitResultPrinter\Model\AssertionFailureSummary\WithValueComparedToValue;
...
class WithValueComparedToValueTest extends AbstractBaseTest
{
    ...
    {
        self::assertSame($expectedRenderedString, $withValueComparedToValue->render());
    }
