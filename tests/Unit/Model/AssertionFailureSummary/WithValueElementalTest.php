...
use webignition\BasilPhpUnitResultPrinter\Model\AssertionFailureSummary\WithValueElemental;
...
class WithValueElementalTest extends AbstractBaseTest
{
    ...
    {
        self::assertSame($expectedRenderedString, $withValueElemental->render());
    }
