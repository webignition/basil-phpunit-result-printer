...
use webignition\BasilPhpUnitResultPrinter\Model\AssertionFailureSummary\ScalarValueComparedToElementalValue;
...
class ScalarValueComparedToElementalValueTest extends AbstractBaseTest
{
    ...
    {
        self::assertSame($expectedRenderedString, $model->render());
    }
