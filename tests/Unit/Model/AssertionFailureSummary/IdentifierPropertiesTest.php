...
use webignition\BasilPhpUnitResultPrinter\Model\AssertionFailureSummary\IdentifierProperties;
...
class IdentifierPropertiesTest extends AbstractBaseTest
{
    ...
    {
        self::assertSame($expectedRenderedString, $identifierProperties->render());
    }
